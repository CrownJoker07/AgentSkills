...
usage() {
    echo "Usage: scripts/create-worktree.sh REPO_PATH WORKSPACE_ROOT BRANCH_NAME [BASE_REF]" >&2
}
...
WORKTREE_PATH="$WORKSPACE_ROOT/worktrees/bugfix/$REPO_NAME/$BRANCH_SLUG"
